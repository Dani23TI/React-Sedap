...
flex justify-between items-center p-4">
            {/* Search Bar */}
            <div id="header-logo" className="flex flex-col">
                <span id="logo-title" className="font-poppins-extrabold text-[34px] text-gray-900">
		                Sedap <p id="logo-dot" className="text-hijau">.</p></span>
            </div>
            <b></b>
            ...
            <a href="/about" className="flex items-center space-x-4">About</a>
            <a href="/ProdukUnggulan">Produk Unggulan</a>
            <a href="/testimonis">Testimoni</a>
            <a href="/cek-member">Cek Member</a>
...
p-3 bg-red-100 rounded-2xl text-red-500 cursor-pointer">
                ...
                <div id="profile-container" className="flex items-center space-x-4 border-l pl-4 border-gray-300">
                    <span id="profile-text">
                        Hello, <b>Dani Raditya Maulana</b>
                    </span>
                    <img
                        id="profile-avatar"
